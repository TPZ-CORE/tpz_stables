...
$(function() {
    ...
    } else if (item.action == 'displayTamingCountdown') {
      
      $("#taming-title").show();
      $("#taming-title-description").show();

      $("#taming-title").text(item.title);
      $("#taming-title-description").text(item.title_description);
    ...
    } else if (item.action == 'updateTamingCountdown') {
