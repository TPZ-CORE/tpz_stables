...
Config.Trainers = {
    ...
    HorseTraining = { 
    	...
    	ExpWhenRearUp  = { UpdateTick = 15,  Experience = 30 },   -- EXPERIENCE TO ADD WHEN THE TRAINER IS REARUP WITH THE HORSE ( DEFAULT IS 15 SECONDS )
    	ExpWhenSkid    = { UpdateTick = 30,  Experience = 60 },   -- EXPERIENCE TO ADD WHEN THE TRAINER IS SKID WITH THE HORSE ( DEFAULT IS 30 SECONDS )
