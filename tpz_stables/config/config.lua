...
Config.HorseShoes = { 
    [1] = { Item = 'regular_horseshoes',  Label = "Regular Horse Shoes",  MaxKilometers = 4000  },
    [2] = { Item = 'improved_horseshoes', Label = "Improved Horse Shoes", MaxKilometers = 16000 },
    [3] = { Item = 'premium_horseshoes',  Label = "Premium Horse Shoes",  MaxKilometers = 32000 },
}
